...
describe('Scope', function() {
  ...
  describe('digest', function() {
    ...
    it('calls listener with new value as old value the firt time', function() {
      scope.someValue = 123;
      var oldValueGiven;
    ...
    it('correct handles NaNs', function() {
    ...
    it('catches expections in listener functions and countinues', function() {
      scope.aValue = 'abc';
      scope.counter = 0;
  ...
  describe('$evalAsync', function() {
    ...
    it('has a $$phase field whole value is the current digest phase', function() {
      scope.aValue = [1, 2, 3];
  ...
  describe('$applyAsync', function() {
    ...
    it('never executes $applyAsynced function inthe same cycle', function(done) {
      scope.aValue = [1, 2, 3];
...
describe('Scope Inheritance', function(){
  ...
  describe('$watchCollection', function() {
    ...
    it('noteices an item removed from an array', function() {
      scope.arr = [1, 2, 3];
      scope.counter = 0;
    ...
    it('notices an item replaced in an argument object', function() {
      (function() {
  ...
  describe('Events', function() {
    ...
    it('allows registring listeners', function() {
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it('passes an event with a name to listeners on' + method, function() {
      ...
      it('passes the same even object to each listener on ' + method, function() {
        var listener1 = jasmine.createSpy();
        var listener2 = jasmine.createSpy();
        scope.$on('someEvent', listener1);
        scope.$on('someEvent', listener2);
    ...
    it('propagares the same event up on $emit', function() {
      var parentListener = jasmine.createSpy();
      var scopeListener = jasmine.createSpy();
    ...
    it('properties the same event down on $broadcast', function() {
      var scopeListener = jasmine.createSpy();
      var childListener = jasmine.createSpy();
    ...
    it('does not propagate to parents whent stopped', function() {
      var scopeListener = function(event) {
